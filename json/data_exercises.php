...
$sql .= "SELECT exercises.*,equipments.equipment_title AS equipment_title, levels.level_title AS level_title FROM exercises,equipments,levels WHERE exercises.exercise_equipment = equipments.equipment_id AND exercises.exercise_level = levels.level_id";

if(isset($_GET['id']) && !empty($_GET['id'])) {
$sql .= " AND exercises.exercise_id=".$_GET["id"];
}

$sql .= " ORDER BY exercises.exercise_id DESC";
